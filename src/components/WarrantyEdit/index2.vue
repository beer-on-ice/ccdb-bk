<template>
	<a-modal title="保单管理-保单服务编辑(新增)"
		...
		<div class="modalTop">
          ...
          {rules: [{ required: true, message: '请选择！', trigger: 'change' }]}]"
									style="width:180px;">
									<a-select-option value="1">友邦</a-select-option>
									<a-select-option value="2">保诚</a-select-option>
									<a-select-option value="3">安盛</a-select-option>
									<a-select-option value="4">大都会</a-select-option>
									<a-select-option value="5">宏利</a-select-option>
									<a-select-option value="6">富通</a-select-option>
								</a-select>
							</a-form-item>
						</div>
					</a-form>
